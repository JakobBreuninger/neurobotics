...
def main():
    ...
    while not rospy.is_shutdown():
        ...
        if ros_handler.new_msg:
            ...
            agent.set_experience(ros_handler.old_costmap, ros_handler.old_action, ros_handler.reward,
                                 ros_handler.new_costmap)

            # Now we don't have a new msg anymore
            ros_handler.new_msg = False
